...
const Home = () => {
  ...
  const getProducts = () => {
    axios.get("https://hilmi-express-mongo.herokuapp.com/api/products")
      .then(res => {
  ...
  useEffect(() => {
    if (search === '') {
      ...
      axios.get('https://hilmi-express-mongo.herokuapp.com/api/products/query/' + search)
        .then(res => {
          const products = res.data
          setProducts(products)
          setLoading(false)
  ...
  const handleDelete = (id) => {
    axios.delete('https://hilmi-express-mongo.herokuapp.com/api/products/' + id)
      .then(res => {
